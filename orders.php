	...
	<body>
		...
		<div class="col-lg-12" >
				...
				<table class="table table-striped table-hover">
					...
					<?php
						$sql = "SELECT * FROM orders o WHERE o.customer_id = ".$_SESSION["id"].";";
						...
						while($row = mysqli_fetch_assoc($result))
						{
							...
							<a id="pressed" style="color:white" href="order_product.php?row_order_id='.$row_order_id.'">See in detail</a> </button>'
